...
public:
	virtual void OnBeforeCommandLineProcessing(const CefString& process_type, CefRefPtr<CefCommandLine> command_line) OVERRIDE
	{
		if (process_type.empty())
		{
			...
			// Offline/lockdown: suppress Chromium background networking and DoH
			command_line->AppendSwitch("--disable-background-networking");
			command_line->AppendSwitch("--run-network-service-in-process");
			command_line->AppendSwitchWithValue("--disable-features", "DnsOverHttps,SecureDns");
