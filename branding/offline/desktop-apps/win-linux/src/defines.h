...
// Offline build: all external product URLs are blanked so the application does
// not ping any online service from the local document editor.
#define URL_SITE                ""
#define URL_SIGNUP              ""
...
// Offline build: legal/download/release links are disabled.
#define URL_AGPL        ""
