...
FROM core-base AS desktop-linux
    ...
    ARG PRODUCT_NAME
    ARG BRANDING_DIR
    ARG DESKTOP_URL_UPDATES_MAIN_CHANNEL=""
    ARG DESKTOP_URL_UPDATES_DEV_CHANNEL=""

    ENV DESKTOP_URL_UPDATES_MAIN_CHANNEL=${DESKTOP_URL_UPDATES_MAIN_CHANNEL}
    ENV DESKTOP_URL_UPDATES_DEV_CHANNEL=${DESKTOP_URL_UPDATES_DEV_CHANNEL}
